<template>
  <div class="transfer" :style="{width,height}" style="margin:0 auto">
    <template v-if="mode == 'transfer'">
      <!-- 左侧穿梭框 原料框 -->
      <div class="transfer-left">
        <div class="transfer-title">
          <span class="transfer-title-font-span" >{{fromTitle}}</span>
        </div>
        <!-- 内容区 -->
      ...
      <div class="transfer-center">
        <template v-if='button_text'>
          <p class="transfer-center-item">
            <Button type="primary" @click="addToAims" icon="ios-arrow-right" :disabled="from_disabled">
              {{fromButton || '添加'}}
            </Button>
          </p>
          <p class="transfer-center-item">
            <Button type="primary" @click='removeToSource' 
            :disabled="to_disabled" icon="ios-arrow-left">{{toButton || '移除'}}</Button>
          </p>
        </template>
        <template v-else>
          <p class="transfer-center-item">
            <Button type="primary" @click="addToAims" icon="ios-arrow-right" circle :disabled="from_disabled"></Button>
          </p>
          <p class="transfer-center-item">
            <Button type="primary" @click='removeToSource' :disabled="to_disabled" icon="ios-arrow-left" circle></Button>
          </p>
        </template>
      </div>
      <!-- 右侧穿梭框 目标框 -->
      <div class="transfer-right">
        <div class="transfer-title">
          <span class="transfer-title-font-span">{{toTitle}}</span>
        </div>
        <!-- 内容区 -->
        <div class="transfer-main">
    ...
    <template v-else-if="mode == 'addressList'">
      ...
      <div class="transfer-center address-list-center">
        <p class="transfer-center-item" v-show='!move_up'>
          <Button type="primary" @click="addressListTransfer(0)" icon="ios-arrow-right" circle :disabled="from_disabled"></Button>
        </p>
        <p class="transfer-center-item">
          <Button type="primary" @click='addressListTransfer(1)' :disabled="from_disabled" icon="ios-arrow-right" circle></Button>
        </p>
        <p class="transfer-center-item" v-show='move_up'>
          <Button type="primary" @click='addressListTransfer(2)' :disabled="from_disabled" icon="ios-arrow-right" circle></Button>
        </p>
      </div>
      <div class="transfer-right">
